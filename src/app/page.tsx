  ...
  return (
    ...
    >
      ...
      <a href="/" className="fixed top-6 left-6 z-40 cursor-pointer">
        <span className="text-black text-xl md:text-2xl font-medium" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
          linkbouquet.com
        </span>
      </a>
              ...
              <div className="flex justify-between">
                {CURATED_BUCKETS.map((bucket, i) => (
                  <button
                    ...
                    className={`rounded-full transition-all ${selectedBucket === i ? "ring-2 ring-black scale-110" : "opacity-60 hover:opacity-100"}`}
                  >
                    <Image
                      src={bucket.pfp}
                      alt={bucket.name}
